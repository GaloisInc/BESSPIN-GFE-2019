...
module mkMem_Controller(CLK,
  ...
  assign MUX_slave_xactor_f_rd_data$enq_1__VAL_1 =
	     { f_reqs_rv[168:165], rdata__h4985, 3'd1 } ;
  ...
  assign n__h4984 = { 3'd0, f_reqs_rv[105:104] } ;
  assign req_raw_mem_addr__h3231 =
	     { 5'd0,
  ...
  assign rg_cached_raw_mem_addr_0_EQ_0_CONCAT_f_reqs_rv_ETC___d134 =
	     rg_cached_raw_mem_addr == req_raw_mem_addr__h3231 ;
  ...
  begin
    case (f_reqs_rv[105:104])
      2'd0: word64_old__h5779 = rg_cached_raw_mem_word[63:0];
      2'd1: word64_old__h5779 = rg_cached_raw_mem_word[127:64];
      2'd2: word64_old__h5779 = rg_cached_raw_mem_word[191:128];
      2'd3: word64_old__h5779 = rg_cached_raw_mem_word[255:192];
    endcase
  end
  always@(n__h4984 or rg_cached_raw_mem_word)
  begin
    case (n__h4984)
      5'd0: rdata__h4985 = rg_cached_raw_mem_word[63:0];
      5'd1: rdata__h4985 = rg_cached_raw_mem_word[127:64];
      5'd2: rdata__h4985 = rg_cached_raw_mem_word[191:128];
      5'd3: rdata__h4985 = rg_cached_raw_mem_word[255:192];
      default: rdata__h4985 = 64'hAAAAAAAAAAAAAAAA /* unspecified value */ ;
    endcase
  end
  ...
  begin
    ...
    v__h3106 = v__h3112 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_merge_wr_req &&
	  NOT_cfg_verbosity_read_ULE_2_2___d33)
	$display("%0d: Mem_Controller.rl_merge_wr_req", v__h3106);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_merge_wr_req &&
	  NOT_cfg_verbosity_read_ULE_2_2___d33)
	$write("        ");
