...
// include an offset, so that we don't overwrite the program!
#define BASE_ADDRESS   (volatile datum *) 0x80010000
 ...
 * Function:    main()
 *
 * Description: Test RAM starting after the current program!
 * 
 * Notes:       
 *
