...
set_property PROGRAM.FILES [list "fpga_primary.mcs" "fpga_secondary.mcs" ] [ get_property PROGRAM.HW_CFGMEM [lindex [get_hw_devices] 0]]
set_property PROGRAM.PRM_FILES [list "fpga_primary.prm" "fpga_secondary.prm" ] [ get_property PROGRAM.HW_CFGMEM [lindex [get_hw_devices] 0]]
